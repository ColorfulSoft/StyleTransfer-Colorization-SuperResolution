...
namespace NeuralColor
{
    ...
    public sealed partial class MainForm : Form
    {
        ...
        {
            // -> MainForm
            this.Text = "Let there be Color! Joint End-to-end Learning of Global and Local Image Priors for Automatic Image Colorization with Simultaneous Classification";
