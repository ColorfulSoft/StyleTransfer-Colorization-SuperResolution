...
namespace NeuralEnhance
{
    ...
    public sealed partial class MainForm : Form
    {
        ...
        {
            // -> MainForm
            this.Text = "Photo-Realistic Single Image Super-Resolution Using a Generative Adversarial Network";
            this.ClientSize = new Size(582, 376);
            this.FormBorderStyle = FormBorderStyle.FixedSingle;
            this.MaximizeBox = false;
            // -> OriginalSettings
            this.OriginalSettings = new GroupBox();
            this.OriginalSettings.Text = "Оригинал";
            ...
            this.OriginalSettings.Left = 10;
              ...
              this.OpenOriginal.Text = "Открыть изображение";
