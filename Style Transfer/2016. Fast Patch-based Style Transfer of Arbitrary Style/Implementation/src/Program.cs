...
namespace NeuralArt
{
    ...
    public sealed partial class MainForm : Form
    {
        ...
        private void Stylize()
        {
            ...
            var Result = StyleTransfer.Stylize(this.encoder,
                                               this.decoder,
                                               content,
                                               style);
        ...
        public MainForm() : base()
        {
            ...
            // Encoder
            this.encoder = new Encoder(Assembly.GetExecutingAssembly().GetManifestResourceStream("vgg19.model"));
            // Decoder
            this.decoder = new Decoder(Assembly.GetExecutingAssembly().GetManifestResourceStream("dec-tconv-sigmoid.model"));
