...
namespace NeuralArt
{
    ...
    public sealed partial class MainForm : Form
    {
        ...
        ///<summary>Список доступных стилей.</summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "Perceptual Losses for Real-Time Style Transfer and Super-Resolution";
            ...
            this.StyleBox.Left = 296;
              ...
              //-> SelectStyle
              this.SelectStyle = new ComboBox();
              this.SelectStyle.Top = 286;
              this.SelectStyle.Left = 10;
              this.SelectStyle.DropDownStyle = ComboBoxStyle.DropDownList;
              this.SelectStyle.Size = new Size(256, 25);
              this.SelectStyle.Items.Add("la muse");
              this.SelectStyle.Items.Add("rain princess");
              this.SelectStyle.Items.Add("scream");
              this.SelectStyle.Items.Add("udnie");
              this.SelectStyle.Items.Add("wave");
              this.SelectStyle.Items.Add("wreck");
              this.SelectStyle.SelectedIndex = 0;
              this.StyleBox.Controls.Add(this.SelectStyle);
