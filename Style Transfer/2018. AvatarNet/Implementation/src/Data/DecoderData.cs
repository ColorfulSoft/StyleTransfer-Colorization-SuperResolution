...
namespace NeuralArt
{
    ...
    public sealed class DecoderData
    {
        ...
        ///<summary>Веса свёрточного слоя Out.</summary>
        public Tensor[] Conv_Out_Weights
        {
            get;
            set;
        }

        ///<summary>Смещения свёрточного слоя Out.</summary>
        public Tensor Conv_Out_Biases
        {
            get;
            set;
        }
        ...
        public DecoderData(Stream s)
        {
            ...
            this.Conv1_1_Weights = LoadWeights(64, 64, 3, 3, br);
            this.Conv1_1_Biases = LoadBiases(64, br);
            this.Conv_Out_Weights = LoadWeights(3, 64, 7, 7, br);
            this.Conv_Out_Biases = LoadBiases(3, br);
            br.Close();
        }
